<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">知识库目录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">节点名称：</text></view>
                  <input  placeholder="请输入节点名称" v-model="model.name"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">父节点：</text></view>
                  <input  placeholder="请输入父节点" v-model="model.pid"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
