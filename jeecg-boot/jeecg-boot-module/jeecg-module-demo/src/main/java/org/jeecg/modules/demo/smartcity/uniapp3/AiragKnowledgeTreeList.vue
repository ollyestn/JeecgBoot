...
layout: 'default',
style: {
navigationBarTitleText: '知识库目录',
navigationStyle: 'custom',
},
}
</route>
<template>
  <PageLayout navTitle="知识库目录"  backRouteName="index" routeMethod="pushTab">
    <view class="wrap">
      <z-paging
          ref="paging"
          :fixed="false"
...
import {columns} from './AiragKnowledgeTreeData';
defineOptions({
  name: 'AiragKnowledgeTreeList',
  options: {
