...
<script lang="tsx">
  ...
  import { knowledgeDocList, knowledgeDeleteBatchDoc, knowledgeDeleteAllDoc, knowledgeRebuildDoc, knowledgeEmbeddingHitTest } from '../AiKnowledgeBaseDetail.api';
  import { doDeleteAllDoc } from '../AiKnowledgeBaseDetail.api.util';
